    ...
    <>
          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "The admission process typically begins in January and continues until all seats are filled. We recommend applying early as seats are limited."
              }
            },
            {
              "@type": "Question",
            ...
            },
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "The entrance assessment evaluates the child's current knowledge level as per their age group. It's best to make sure they are familiar with the concepts taught in their previous class. No special preparation is required."
              }
            },
            {
              "@type": "Question",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "HowTo",
          "name": "JGPS Admission Process 2027-28",
          "description": "Step-by-step guide to the admission process at Jai Govind Public School",
          "totalTime": "PT15M",
          "step": [
            {
              "@type": "HowToStep",
              "name": "Application Submission",
              "text": "Fill out the application form and submit it along with the required documents. The application form can be collected from the school office or downloaded from our website.",
              "url": "https://jgps.in/admission"
            },
            {
              "@type": "HowToStep",
              "name": "Entrance Assessment",
              "text": "Students seeking admission to Class 1 and above will take an entrance assessment to evaluate their current academic level. For nursery admissions, an informal interaction with the child and parents is conducted.",
              "url": "https://jgps.in/admission"
            },
            {
              "@type": "HowToStep",
              "name": "Parent Interview",
              "text": "A brief interview with parents/guardians will be conducted to understand the child's background, interests, and needs.",
              "url": "https://jgps.in/admission"
            },
            {
              "@type": "HowToStep",
              "name": "Admission Decision",
              "text": "Based on the application, assessment results, and interview, the admission decision will be communicated to the parents/guardians.",
              "url": "https://jgps.in/admission"
            },
            {
              "@type": "HowToStep",
              "name": "Fee Payment",
              "text": "Upon acceptance, parents/guardians are required to pay the admission fee and first term fee to confirm the admission.",
              "url": "https://jgps.in/admission"
            }
          ]
        }) }}
