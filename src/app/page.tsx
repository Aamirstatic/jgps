...
export const metadata: Metadata = {
  ...
  description: "Jai Govind Public School (JGPS) - Premium English medium school in Joya, Amroha offering CBSE education from Nursery to Class 8 with expert coaching for AMU, JMI, Sainik School, Military School & Vidyagyan entrance exams. Admissions open for 2027-28 session.",
