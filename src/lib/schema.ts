...
export function generateSchemaMarkup() {
  const brandSchema = {
    "@type": "Brand",
    "@id": "https://jgps.in/#brand",
    "name": schoolData.name,
    "description": `${schoolData.name} provides CBSE education from ${schoolData.classes} with specialized entrance exam coaching for top Indian schools. Located at ${schoolData.address}.`,
    "url": "https://jgps.in",
    "logo": {
      "@type": "ImageObject",
